...
En esta aplicación hasta ahora nada funcional, te propongo crear un módulo con un único componente para mostrar el contenido de la página *home* de la aplicación. Puede parecer sobre-ingeniería, pero a la larga le verás sentido, y por ahora te permitirá practicar con la creación de módulos y componentes.
